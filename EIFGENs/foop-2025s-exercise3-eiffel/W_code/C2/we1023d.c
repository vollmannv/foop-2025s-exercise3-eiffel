...
static const struct desc_info desc_1023[] = {
	...
	{EIF_NON_GENERIC(0x01BD /*222*/), 15357, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15358, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15359, 0xFFFFFFFF},
};
void Init1023(void)
{
	IDSC(desc_1023, 0, 1022);
	IDSC(desc_1023 + 1, 1, 1022);
	IDSC(desc_1023 + 32, 627, 1022);
}
