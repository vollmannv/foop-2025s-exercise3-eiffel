/*
 * Code for class EV_MODEL_ROTATED_PIE_SLICE
 */
...
extern void F1847_23854(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1847_23855(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1847_23856(EIF_REFERENCE);
extern void F1847_23857(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1847_23858(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1847_23859(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1847_23860(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1847_24157(EIF_REFERENCE, int);
...
/* {EV_MODEL_ROTATED_PIE_SLICE}.default_create */
void F1847_23854 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1846, Current, 0, 0, 29225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1846, Current, 29225);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(32, 1840))(Current);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 18738, 0x20000000, 1); /* start_angle */
	*(EIF_REAL_64 *)(Current + RTWA(18738, dtype)) = (EIF_REAL_64) (EIF_REAL_64) 0.2;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 18739, 0x20000000, 1); /* aperture */
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1612, dtype))(Current)).it_r8);
	*(EIF_REAL_64 *)(Current + RTWA(18739, dtype)) = (EIF_REAL_64) tr8_1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
/* {EV_MODEL_ROTATED_PIE_SLICE}.start_angle */
EIF_TYPED_VALUE F1847_23855 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(18738,Dtype(Current)));
	return r;
}


/* {EV_MODEL_ROTATED_PIE_SLICE}.aperture */
EIF_TYPED_VALUE F1847_23856 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(18739,Dtype(Current)));
	return r;
}


/* {EV_MODEL_ROTATED_PIE_SLICE}.project */
void F1847_23857 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1846, Current, 0, 1, 29228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1846, Current, 29228);
	RTCC(arg1, 1846, l_feature_name, 1, eif_new_type(1860, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(18831, "draw_figure_rotated_pie_slice", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {EV_MODEL_ROTATED_PIE_SLICE}.set_start_angle */
void F1847_23858 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 1846, Current, 0, 1, 29229);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1846, Current, 29229);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 18738, 0x20000000, 1); /* start_angle */
	*(EIF_REAL_64 *)(Current + RTWA(18738, dtype)) = (EIF_REAL_64) arg1;
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(18575, dtype))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("start_angle_assigned", EX_POST);
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(18738, dtype));
...
/* {EV_MODEL_ROTATED_PIE_SLICE}.set_aperture */
void F1847_23859 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 1846, Current, 0, 1, 29230);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1846, Current, 29230);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 18739, 0x20000000, 1); /* aperture */
	*(EIF_REAL_64 *)(Current + RTWA(18739, dtype)) = (EIF_REAL_64) arg1;
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(18575, dtype))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("aperture_assigned", EX_POST);
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(18739, dtype));
		if ((EIF_BOOLEAN) eif_is_equal_real_64 (tr8_1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
/* {EV_MODEL_ROTATED_PIE_SLICE}.position_on_figure */
EIF_TYPED_VALUE F1847_23860 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1846, Current, 15, 2, 29231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1846, Current, 29231);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(18739, dtype));
	if ((EIF_BOOLEAN) !eif_is_equal_real_64 (tr8_1, (EIF_REAL_64) 0.0)) {
		...
		ur8_3 = loc15;
		tr8_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1632, dtype))(Current, ur8_3x)).it_r8);
		tr8_4 = (EIF_REAL_64) (arg2);
		ur8_3 = loc15;
		tr8_5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1634, dtype))(Current, ur8_3x)).it_r8);
		ur8_3 = (EIF_REAL_64) ((EIF_REAL_64) (tr8_2 * tr8_3) - (EIF_REAL_64) (tr8_4 * tr8_5));
		tr8_6 = (EIF_REAL_64) (arg1);
		ur8_4 = loc15;
		tr8_7 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1634, dtype))(Current, ur8_4x)).it_r8);
		tr8_8 = (EIF_REAL_64) (arg2);
		ur8_4 = loc15;
		tr8_9 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1632, dtype))(Current, ur8_4x)).it_r8);
		ur8_4 = (EIF_REAL_64) ((EIF_REAL_64) (tr8_6 * tr8_7) + (EIF_REAL_64) (tr8_8 * tr8_9));
		...
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(18738, dtype));
		tr8_2 = *(EIF_REAL_64 *)(Current + RTWA(18739, dtype));
...
/* {EV_MODEL_ROTATED_PIE_SLICE}._invariant */
void F1847_24157 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1846, Current, 0, 24156);
	RTSA(dtype);
	RTME(dtype, 0);
