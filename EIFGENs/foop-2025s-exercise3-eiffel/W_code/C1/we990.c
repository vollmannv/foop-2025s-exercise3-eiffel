...
extern void F990_9030(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F990_9031(EIF_REFERENCE);
extern EIF_TYPED_VALUE F990_9032(EIF_REFERENCE);
...
void F990_9030 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 989, Current, 0, 1, 14968);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 14968);
	RTCC(arg1, 989, l_feature_name, 1, eif_new_type(1008, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6818, 0xF80003F0, 0); /* guid */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F990_9031 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F990_9032 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 989, Current, 2, 0, 14970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 14970);
	RTIV(Current, RTAL);
	RTHOOK(1);
