...
static const struct desc_info desc_1000[] = {
	...
	{EIF_NON_GENERIC(0x01BD /*222*/), 15066, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15067, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x019F /*207*/), 15068, 0xFFFFFFFF},
};
void Init1000(void)
{
	IDSC(desc_1000, 0, 999);
	IDSC(desc_1000 + 1, 1, 999);
	IDSC(desc_1000 + 32, 972, 999);
}
