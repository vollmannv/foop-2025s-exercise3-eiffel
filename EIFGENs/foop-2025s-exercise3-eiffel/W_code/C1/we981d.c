...
static const EIF_TYPE_INDEX egt_13_981 [] = {0xFF01,168,0xFFFF};
...
static const struct desc_info desc_981[] = {
	...
	{EIF_NON_GENERIC(0x01BD /*222*/), 14862, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 14863, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 14864, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01CF /*231*/), 14865, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_981), 14866, 0},
	{EIF_NON_GENERIC(0x01BD /*222*/), 14867, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 14868, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 14869, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 14870, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 14871, 0xFFFFFFFF},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	IDSC(desc_981 + 1, 1, 980);
	IDSC(desc_981 + 32, 1157, 980);
}
