...
extern EIF_TYPED_VALUE F998_9112(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_9113(EIF_REFERENCE);
...
EIF_TYPED_VALUE F998_9112 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F998_9113 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 997, Current, 0, 1, 15054);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 15054);
	RTIV(Current, RTAL);
	RTHOOK(1);
	switch (arg1) {
		case 0L:
	...
	if (RTAL & CK_ENSURE) {
		...
		*((EIF_INTEGER_32 *)tr2+2) = (EIF_INTEGER_32) ti4_1;
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6902, dtype))(Current)).it_i4);
