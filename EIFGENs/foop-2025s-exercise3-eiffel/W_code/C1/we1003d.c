...
static const EIF_TYPE_INDEX egt_13_1003 [] = {0xFF01,682,195,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1003 [] = {0xFF01,168,0xFFFF};
...
static const struct desc_info desc_1003[] = {
	...
	{EIF_NON_GENERIC(0x01BD /*222*/), 15087, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0187 /*195*/), 15088, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_1003), 15089, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01CF /*231*/), 15090, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1003), 15091, 0},
	{EIF_GENERIC(NULL), 15092, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0187 /*195*/), 15093, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15094, 0xFFFFFFFF},
};
void Init1003(void)
{
	IDSC(desc_1003, 0, 1002);
	IDSC(desc_1003 + 1, 1, 1002);
	IDSC(desc_1003 + 32, 953, 1002);
}
