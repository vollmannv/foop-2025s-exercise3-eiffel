...
static const struct desc_info desc_1001[] = {
	...
	{EIF_NON_GENERIC(0x01BD /*222*/), 15069, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15070, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15071, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15072, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15073, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15074, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BD /*222*/), 15075, 0xFFFFFFFF},
};
void Init1001(void)
{
	IDSC(desc_1001, 0, 1000);
	IDSC(desc_1001 + 1, 1, 1000);
	IDSC(desc_1001 + 32, 968, 1000);
}
