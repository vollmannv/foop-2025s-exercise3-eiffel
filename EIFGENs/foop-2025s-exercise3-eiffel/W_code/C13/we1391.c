...
extern void F1391_16197(EIF_REFERENCE);
extern void F1391_16198(EIF_REFERENCE);
extern void F1391_16199(EIF_REFERENCE);
extern void F1391_16200(EIF_REFERENCE);
...
/* {WEL_SCREEN_DC}.get */
void F1391_16197 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1390, Current, 1, 0, 22434);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1390, Current, 22434);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1391_16198 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1390, Current, 1, 0, 22435);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1390, Current, 22435);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = *(EIF_POINTER *)(Current + RTWA(11388, dtype));
	if ((EIF_BOOLEAN)(tp1 != loc1)) {
...
void F1391_16199 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1390, Current, 1, 0, 22436);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1390, Current, 22436);
	RTIV(Current, RTAL);
...
void F1391_16200 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1390, Current, 1, 0, 22437);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1390, Current, 22437);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
