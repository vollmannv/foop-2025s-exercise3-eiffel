...
extern EIF_TYPED_VALUE F1888_24954(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1888_24954 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1887, Current, 0, 0, 29720);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1887, Current, 29720);
	RTIV(Current, RTAL);
	RTHOOK(1);
