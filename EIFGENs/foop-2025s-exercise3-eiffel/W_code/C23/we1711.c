...
extern EIF_TYPED_VALUE F1711_20928(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1711_20929(EIF_REFERENCE);
...
RTOID (F1711_20928)
EIF_TYPED_VALUE F1711_20928 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1711_20928);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1710, Current, 0, 0, 26566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1710, Current, 26566);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1711_20929 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1710, Current, 0, 0, 26567);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1710, Current, 26567);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
