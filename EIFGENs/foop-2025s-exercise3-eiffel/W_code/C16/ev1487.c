...
extern EIF_TYPED_VALUE F1487_17326(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1487_17327(EIF_REFERENCE);
extern void F1487_17328(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1487_17326 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1486, Current, 0, 0, 23551);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1486, Current, 23551);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(13894, 1480))(Current)).it_b);
	if (tb2) {
...
EIF_TYPED_VALUE F1487_17327 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1487_17328 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1486, Current, 0, 0, 23553);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1486, Current, 23553);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 13889, 0xF8000640, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1767, 0x01).id);
