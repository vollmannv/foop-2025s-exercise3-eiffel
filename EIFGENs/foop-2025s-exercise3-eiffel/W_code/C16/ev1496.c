...
extern EIF_TYPED_VALUE F1496_17367(EIF_REFERENCE);
extern void F1496_17368(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1496_17367 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1496_17368 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1495, Current, 0, 0, 23591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1495, Current, 23591);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 13889, 0xF8000647, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1733, 0x01).id);
