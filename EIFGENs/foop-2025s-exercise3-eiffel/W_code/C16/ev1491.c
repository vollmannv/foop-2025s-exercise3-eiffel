...
extern EIF_TYPED_VALUE F1491_17343(EIF_REFERENCE);
extern void F1491_17344(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1491_17343 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1491_17344 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 23569);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 23569);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 13889, 0xF8000645, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1772, 0x01).id);
