...
extern EIF_TYPED_VALUE F1498_17379(EIF_REFERENCE);
extern void F1498_17380(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1498_17379 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1498_17380 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1497, Current, 0, 0, 23603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1497, Current, 23603);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 13889, 0xF8000652, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1735, 0x01).id);
