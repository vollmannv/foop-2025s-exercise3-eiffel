...
extern void F1276_13786(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1276_13787(EIF_REFERENCE);
...
void F1276_13786 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1275, Current, 0, 0, 20017);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1275, Current, 20017);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1276_13787 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1276_13787,20019,RTMS_EX_H("comctl32.dll",12,1700689004));
}

void EIF_Minit1276 (void)
{
	GTCX
	RTOTS (13787,F1276_13787)
}
