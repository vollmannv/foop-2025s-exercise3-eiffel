...
extern void F1588_18606(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1588_18607_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1588_18607(EIF_REFERENCE);
...
void F1588_18606 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1587, Current, 1, 1, 24456);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1587, Current, 24456);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(15763, "update_for_pick_and_drop", tr2))(tr2, ub1x);
		RTHOOK(5);
...
static EIF_TYPED_VALUE F1588_18607_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1587, Current, 0, 0, 24457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1587, Current, 24457);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1588_18607 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(14729, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1588_18607_body (Current)).it_r;
