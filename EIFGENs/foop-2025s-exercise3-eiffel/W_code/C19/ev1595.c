...
extern EIF_TYPED_VALUE F1595_18662(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1595_18663(EIF_REFERENCE);
extern void F1595_18671(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1595_18672_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1595_18672(EIF_REFERENCE);
extern void F1595_23295(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1595_18662 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(15660,Dtype(Current)));
	return r;
}


/* {EV_GAUGE_I}.proportion */
EIF_TYPED_VALUE F1595_18663 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1594, Current, 2, 0, 24474);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1594, Current, 24474);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1595_18671 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1594, Current, 2, 1, 24475);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1594, Current, 24475);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		...
		*(EIF_REAL_32 *)tr1 = (EIF_REAL_32) (tr4_1 * arg1);
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(15666, dtype))(Current, ui4_1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
static EIF_TYPED_VALUE F1595_18672_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1594, Current, 0, 0, 24476);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1594, Current, 24476);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1595_18672 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(14729, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1595_18672_body (Current)).it_r;
...
void F1595_23295 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1594, Current, 0, 23294);
	RTSA(dtype);
	RTME(dtype, 0);
