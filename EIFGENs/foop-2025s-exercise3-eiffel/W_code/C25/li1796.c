...
extern void F1796_3504(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1796_3505(EIF_REFERENCE);
extern void F1796_3506(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1796_3507(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1796_3508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1796_3509(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1796_3510(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1796_3511(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1796_3504 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1795, Current, 1, 1, 19443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19443);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F1796_3505 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1795, Current, 1, 0, 19444);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19444);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F1796_3506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1795, Current, 0, 1, 19445);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19445);
	RTCC(arg1, 1795, l_feature_name, 1, RTWCT(2245, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(2742, dtype));
		ti4_1 = ti4_2;
		in_assertion = 0;
	}
	RTHOOK(3);
...
/* {LINKED_STACK}.extend */
void F1796_3507 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1795, Current, 0, 1, 19446);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19446);
	RTCC(arg1, 1795, l_feature_name, 1, RTWCT(2245, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F1796_3508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1795, Current, 0, 1, 19447);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19447);
	RTCC(arg1, 1795, l_feature_name, 1, RTWCT(2245, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {LINKED_STACK}.remove */
void F1796_3509 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1795, Current, 0, 0, 19448);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19448);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2279, dtype))(Current);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2745, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1796_3510 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1795, Current, 1, 0, 19449);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19449);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		RTHOOK(4);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(2741, dtype));
		if (tb1) break;
		RTHOOK(5);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2744, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
...
EIF_TYPED_VALUE F1796_3511 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1795, Current, 3, 1, 19450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 19450);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_off_unless_after", EX_PRE);
		tb1 = '\01';
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2278, dtype))(Current)).it_b);
		if (tb2) {
			tb2 = *(EIF_BOOLEAN *)(Current + RTWA(2741, dtype));
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
body:;
	RTHOOK(4);
	RTDBGAL(0, 0xF8000703, 0,0); /* Result */
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		for (;;) {
			...
			RTHOOK(10);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2294, "finish", loc3))(loc3);
			RTHOOK(11);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2744, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2692, "put_right", loc3))(loc3, ur1x);
			RTHOOK(12);
