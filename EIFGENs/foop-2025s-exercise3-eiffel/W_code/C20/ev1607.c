...
extern EIF_TYPED_VALUE F1607_18776(EIF_REFERENCE);
static EIF_TYPED_VALUE F1607_18779_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1607_18779(EIF_REFERENCE);
...
/* {EV_ITEM_I}.parent */
EIF_TYPED_VALUE F1607_18776 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1606, Current, 1, 0, 24511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1606, Current, 24511);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {1785,0xFF01,1491,0xFFFF};
			EIF_TYPE typres0;
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1607_18779_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1606, Current, 0, 0, 24512);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1606, Current, 24512);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1607_18779 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(14729, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1607_18779_body (Current)).it_r;
