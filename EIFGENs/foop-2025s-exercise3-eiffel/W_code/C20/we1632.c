...
extern EIF_TYPED_VALUE F1632_18966(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1632_18966 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1631, Current, 1, 1, 24619);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 24619);
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = RTCCL(tr1);
	loc1 = RTRV(RTWCT(15902, dtype, Dftype(Current)),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
