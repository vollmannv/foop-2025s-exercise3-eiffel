...
extern EIF_TYPED_VALUE F1616_18798(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1616_18801(EIF_REFERENCE);
static EIF_TYPED_VALUE F1616_18802_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1616_18802(EIF_REFERENCE);
...
/* {EV_MENU_I}.parent */
EIF_TYPED_VALUE F1616_18798 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1615, Current, 1, 0, 24527);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1615, Current, 24527);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = RTCCL(tr1);
		Result = RTRV(eif_new_type(1514, 0x00), Result);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
EIF_TYPED_VALUE F1616_18801 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1615, Current, 4, 0, 24528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1615, Current, 24528);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(15064, dtype));
		ti4_1 = ti4_2;
		in_assertion = 0;
	}
	RTHOOK(1);
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN)(loc3 != NULL)) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(14143, "is_selected", loc3))(loc3)).it_b);
			tb2 = tb3;
		}
		if (tb2) {
			RTHOOK(10);
...
/* {EV_MENU_I}.interface */
static EIF_TYPED_VALUE F1616_18802_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1615, Current, 0, 0, 24529);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1615, Current, 24529);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1616_18802 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(14729, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1616_18802_body (Current)).it_r;
