...
extern EIF_TYPED_VALUE F1566_18282(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1566_18282 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1565, Current, 0, 0, 24274);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1565, Current, 24274);
	RTIV(Current, RTAL);
	RTHOOK(1);
