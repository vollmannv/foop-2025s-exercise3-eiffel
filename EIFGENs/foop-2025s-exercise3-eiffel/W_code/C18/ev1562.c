...
extern EIF_TYPED_VALUE F1562_18257(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1562_18258(EIF_REFERENCE);
extern void F1562_18259(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1562_18260(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1562_18261(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1562_18257 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1561, Current, 1, 0, 24262);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1561, Current, 24262);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1562_18258 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1561, Current, 1, 0, 24263);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1561, Current, 24263);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15313, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		...
		Result = RTCCL(tr1);
		Result = RTRV(eif_new_type(1204, 0x00), Result);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
void F1562_18259 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1561, Current, 0, 1, 24259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1561, Current, 24259);
	RTCC(arg1, 1561, l_feature_name, 1, eif_new_type(1478, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1562_18260 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1561, Current, 0, 0, 24260);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1561, Current, 24260);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15313, 0xF80005C6, 0); /* private_pixmap */
...
EIF_TYPED_VALUE F1562_18261 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(15313,Dtype(Current)));
	return r;
}
