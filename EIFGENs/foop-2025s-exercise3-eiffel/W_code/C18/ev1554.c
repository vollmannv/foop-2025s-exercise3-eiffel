...
extern EIF_TYPED_VALUE F1554_18230(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1554_18231(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1554_18232(EIF_REFERENCE);
extern void F1554_18233(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1554_18234(EIF_REFERENCE);
extern void F1554_18235(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1554_18230 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1553, Current, 2, 0, 24240);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1553, Current, 24240);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF800026B, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,619,0xFF01,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
	...
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15292, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = RTCCL(tr1);
	if (EIF_TEST(loc2)) {
		RTHOOK(3);
		...
		if (RTAL & CK_CHECK) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15288, dtype))(Current)).it_b);
			if (tb2) {
				RTCK;
			} else {
				RTCF;
...
EIF_TYPED_VALUE F1554_18231 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1553, Current, 3, 0, 24241);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1553, Current, 24241);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15292, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc3 = RTCCL(tr1);
	if (EIF_TEST(loc3)) {
		...
		loc1 = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(3);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2279, "start", loc3))(loc3);
		for (;;) {
			RTHOOK(4);
			tb1 = '\01';
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2278, "off", loc3))(loc3)).it_b);
			if (!tb2) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15288, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
			...
			RTHOOK(7);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2295, "forth", loc3))(loc3);
		}
		RTHOOK(8);
		ur1 = RTCCL(loc1);
...
EIF_TYPED_VALUE F1554_18232 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(15292,Dtype(Current)));
	return r;
}


/* {EV_RADIO_PEER_IMP}.set_radio_group */
void F1554_18233 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1553, Current, 2, 1, 24243);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1553, Current, 24243);
	RTCC(arg1, 1553, l_feature_name, 1, RTWCT(15292, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15294, dtype))(Current);
	}
	RTHOOK(5);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(15295, dtype))(Current, ur1x);
	RTHOOK(6);
	...
	RTHOOK(9);
	ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(2742, "count", loc1));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
		RTHOOK(10);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15291, dtype))(Current);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
...
void F1554_18234 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1553, Current, 1, 0, 24244);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1553, Current, 24244);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(5);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2210, "prune", loc1))(loc1, ur1x);
	RTHOOK(6);
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 15292, 0xF800026B, 0); /* radio_group */
	*(EIF_REFERENCE *)(Current + RTWA(15292, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F1554_18235 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1553, Current, 0, 1, 24245);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1553, Current, 24245);
	RTCC(arg1, 1553, l_feature_name, 1, RTWCT(15292, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15292, 0xF800026B, 0); /* radio_group */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(15292, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
