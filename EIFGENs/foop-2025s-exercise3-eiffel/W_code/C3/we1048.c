...
extern EIF_TYPED_VALUE F1048_10088(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1048_10088 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1047, Current, 0, 0, 16028);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1047, Current, 16028);
	RTIV(Current, RTAL);
