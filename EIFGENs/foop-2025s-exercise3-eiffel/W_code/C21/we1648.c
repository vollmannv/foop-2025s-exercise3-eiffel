...
extern EIF_TYPED_VALUE F1648_19214(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1648_19214 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1647, Current, 0, 0, 24868);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1647, Current, 24868);
	RTIV(Current, RTAL);
	RTHOOK(1);
