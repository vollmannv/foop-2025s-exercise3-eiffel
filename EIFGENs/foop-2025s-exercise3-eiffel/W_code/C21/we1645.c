...
extern EIF_TYPED_VALUE F1645_19192(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1645_19192 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1644, Current, 0, 0, 24846);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1644, Current, 24846);
	RTIV(Current, RTAL);
	RTHOOK(1);
