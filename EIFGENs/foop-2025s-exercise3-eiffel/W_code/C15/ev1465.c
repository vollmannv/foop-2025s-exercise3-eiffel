...
extern EIF_TYPED_VALUE F1465_17023(EIF_REFERENCE);
extern void F1465_17024(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1465_17023 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1465_17024 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1464, Current, 0, 0, 23240);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1464, Current, 23240);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 13889, 0xF8000627, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1744, 0x01).id);
