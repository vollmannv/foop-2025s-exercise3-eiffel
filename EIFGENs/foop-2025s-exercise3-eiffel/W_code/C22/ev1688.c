...
extern void F1688_20499(EIF_REFERENCE);
extern void F1688_20500(EIF_REFERENCE);
extern void F1688_20501(EIF_REFERENCE);
...
void F1688_20499 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_6 ui4_6x.it_i4
	...
	RTEAA(l_feature_name, 1687, Current, 0, 0, 26140);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1687, Current, 26140);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1688_20500 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1687, Current, 1, 0, 26141);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1687, Current, 26141);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9296, "theme_changed_actions", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = NULL;
...
void F1688_20501 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1687, Current, 2, 0, 26142);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1687, Current, 26142);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(17100, 1686))(Current);
	RTHOOK(2);
	RTDBGAL(1, 0xF8000597, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1431, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
	...
	RTHOOK(4);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9298, "system_color_change_actions", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3074, "call", tr1))(tr1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
