...
extern void F1686_20478(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1686_20479(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1686_20480(EIF_REFERENCE);
...
void F1686_20478 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1685, Current, 0, 1, 26119);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1685, Current, 26119);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(17137, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
...
void F1686_20479 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1685, Current, 1, 1, 26120);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1685, Current, 26120);
	RTCC(arg1, 1685, l_feature_name, 1, eif_new_type(233, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1686_20480 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1685, Current, 1, 0, 26121);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1685, Current, 26121);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
