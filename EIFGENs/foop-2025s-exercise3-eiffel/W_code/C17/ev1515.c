...
extern EIF_TYPED_VALUE F1515_17512(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1515_17513(EIF_REFERENCE);
extern void F1515_23277(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1515_17512 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1514, Current, 1, 1, 23738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1514, Current, 23738);
	RTCC(arg1, 1514, l_feature_name, 1, RTWCT(2245, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = RTCCL(tr1);
	loc1 = RTRV(eif_new_type(1514, 0x01),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(4);
		...
		if (!RTEQ(tr1, arg1)) {
			ur1 = RTCCL(arg1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(14305, "is_parent_recursive", loc1))(loc1, ur1x)).it_b);
			tb1 = tb2;
		}
...
EIF_TYPED_VALUE F1515_17513 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1515_23277 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1514, Current, 0, 23276);
	RTSA(dtype);
	RTME(dtype, 0);
